...
based on the algorithms proposed in the following 6 papers:

NHTP------------------------------------------------------------------------
    Shenglong Zhou, Naihua Xiu, and Houduo Qi, 
...
PSNP------------------------------------------------------------------------
    Shenglong Zhou, Xianchao Xiu, and Dingtao Peng, 
...
MIRL1-----------------------------------------------------------------------
    Shenglong Zhou, Naihua Xiu, Yingnan Wang, Lingchen Kong and Houduo Qi, 
...
solver  = {'NHTP', 'GPNP', 'IIHT', 'NL0R', 'PSNP', 'MIRL1'};
out     = CSpack(A,[],b,n,s,solver{4}); 
