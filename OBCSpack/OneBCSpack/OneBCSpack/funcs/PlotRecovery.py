...
def plot_recovery(x_true: Sequence[float], x_est: Sequence[float], pos, show_stats: bool):
    """Python translation of the MATLAB ``PlotRecovery`` utility."""
